...
public class SelectFromListByLabelRuleTest extends AbstractActionRuleTest {

    @InjectMocks
    private SelectFromListByLabelRule selectFromListByLabelRule;

    @ParameterizedTest
    @MethodSource("applicableTestCases")
    public void isApplicableTest(RelationModel relation) {
        runApplicableTest(relation, mock -> selectFromListByLabelRule.isApplicable(mock));
    }

    @ParameterizedTest
    @MethodSource("inapplicableTestCases")
    public void isInapplicableTest(RelationModel relation) {
        runInapplicableActionTest(relation, mock -> selectFromListByLabelRule.isApplicable(mock));
    }
