...
public class UnselectAllFromListRuleTest extends AbstractActionRuleTest {

    @InjectMocks
    private UnselectAllFromListRule unselectAllFromListRule;

    @ParameterizedTest
    @MethodSource("applicableTestCases")
    public void isApplicableTest(RelationModel relation) {
        runApplicableTest(relation, mock -> unselectAllFromListRule.isApplicable(mock));
    }

    @ParameterizedTest
    @MethodSource("inapplicableTestCases")
    public void isInapplicableTest(RelationModel relation) {
        runInapplicableActionTest(relation, mock -> unselectAllFromListRule.isApplicable(mock));
    }
