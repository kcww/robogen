...
public class WaitUntilPageContainsRuleTest extends AbstractNonElementRuleTest {

    @InjectMocks
    private WaitUntilPageContainsRule rule;
    ...
    private static final Set<String> inaptStepTexts = Set.of(
            ...
            "Given until the page contains \"Hotel Booking\" header",
