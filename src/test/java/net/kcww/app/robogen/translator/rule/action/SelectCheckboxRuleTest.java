...
public class SelectCheckboxRuleTest extends AbstractActionRuleTest {

    @InjectMocks
    private SelectCheckboxRule selectCheckboxRule;

    @ParameterizedTest
    @MethodSource("applicableTestCases")
    public void isApplicableTest(RelationModel relation) {
        runApplicableTest(relation, mock -> selectCheckboxRule.isApplicable(mock));
    }

    @ParameterizedTest
    @MethodSource("inapplicableTestCases")
    public void isInapplicableTest(RelationModel relation) {
        runInapplicableActionTest(relation, mock -> selectCheckboxRule.isApplicable(mock));
    }
