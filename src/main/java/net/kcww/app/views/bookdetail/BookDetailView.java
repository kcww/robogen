package net.kcww.app.views.bookdetail;
...
import net.kcww.app.data.entity.SampleBook;
import net.kcww.app.data.service.SampleBookService;
import net.kcww.app.views.MainLayout;
import org.springframework.data.domain.PageRequest;
import org.springframework.orm.ObjectOptimisticLockingFailureException;

@PageTitle("Book Detail")
@Route(value = "book-detail/:sampleBookID?/:action?(edit)", layout = MainLayout.class)
@AnonymousAllowed
@Tag("book-detail-view")
@JsModule("./views/bookdetail/book-detail-view.ts")
public class BookDetailView extends LitTemplate implements HasStyle, BeforeEnterObserver {

    private final String SAMPLEBOOK_ID = "sampleBookID";
    private final String SAMPLEBOOK_EDIT_ROUTE_TEMPLATE = "book-detail/%s/edit";
    ...
    public BookDetailView(SampleBookService sampleBookService) {
        this.sampleBookService = sampleBookService;
        addClassNames("book-detail-view");
        ...
        grid.addColumn(SampleBook::getName).setHeader("Name").setSortProperty("name").setAutoWidth(true);
        grid.addColumn(SampleBook::getAuthor).setHeader("Author").setSortProperty("author").setAutoWidth(true);
        grid.addColumn(SampleBook::getPublicationDate).setHeader("Publication Date").setSortProperty("publicationDate")
                .setAutoWidth(true);
        grid.addColumn(SampleBook::getPages).setHeader("Pages").setSortProperty("pages").setAutoWidth(true);
        grid.addColumn(SampleBook::getIsbn).setHeader("Isbn").setSortProperty("isbn").setAutoWidth(true);
