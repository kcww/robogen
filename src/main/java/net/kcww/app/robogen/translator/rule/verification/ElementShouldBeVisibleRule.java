...
public final class ElementShouldBeVisibleRule extends AbstractElementRule {
    ...
    public static final SeleniumKeyword SELENIUM_KEYWORD = SeleniumKeywordEnum.ELEMENT_SHOULD_BE_VISIBLE;
    ...
    public boolean isApplicable(StepRelation relation) {
        return super.isApplicable(relation) && Words.hasVisible(relation.parsedStep().text());
    }
}
