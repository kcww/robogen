...
public final class SelectAllFromListRule extends AbstractElementRule {
    ...
    public static final SeleniumKeyword KEYWORD = SeleniumKeywordEnum.SELECT_ALL_FROM_LIST;
    ...
    public boolean isApplicable(RelationModel relation) {
        return super.isApplicable(relation) && Words.hasWholeSelection(relation.scenarioStep().text());
    }
}
