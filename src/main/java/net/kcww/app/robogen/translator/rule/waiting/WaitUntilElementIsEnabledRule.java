...
@Service
public final class WaitUntilElementIsEnabledRule extends AbstractElementRule {

    public static final SeleniumKeyword SELENIUM_KEYWORD = SeleniumKeywordEnum.WAIT_UNTIL_ELEMENT_IS_ENABLED;

    public WaitUntilElementIsEnabledRule() {
    ...
    public boolean isApplicable(StepRelation relation) {
        ...
        return Words.hasWait(stepText) && Words.hasEnable(stepText);
    }
}
